...
// --- Tipagem para os dados dos imóveis (ajustada para sua API) ---
interface Property {
    _id: string;
    title: string;
...
export default function PropertiesPage() {
    // Estado para a lista de todos os imóveis
    ...
    // Efeito para buscar a lista de imóveis quando a página carrega
    useEffect(() => {
                                    ...
                                    <div className="p-4 sm:p-6">
                                        ...
                                        <div className="grid grid-cols-3 gap-2 sm:gap-4 text-xs sm:text-sm text-gray-600 mb-3">
                                            <div className="flex items-center">
                                                ...
                                                <span className="truncate">{prop.bedrooms} quartos</span>
                                            </div>
                                            <div className="flex items-center">
                                                <Bath className="h-3 w-3 sm:h-4 sm:w-4 mr-1 flex-shrink-0" />
                                                <span className="truncate">{prop.bathrooms} banheiros</span>
                                            </div>
                                            <div className="flex items-center">
                                                <Car className="h-3 w-3 sm:h-4 sm:w-4 mr-1 flex-shrink-0" />
                                                <span className="truncate">{prop.parkingSpaces} vagas</span>
                                            </div>
                                        </div>

                                        {prop.totalArea && (
                                            <div className="text-xs sm:text-sm text-gray-600 mb-3">
                                                <span className="font-medium">Área:</span> {prop.totalArea}m²
                                            </div>
                                        )}
                                                ...
                                                <div className="bg-primary-50 p-4 rounded-lg flex items-center justify-between">
                                                    <div>
                                                        ...
                                                        {selectedProperty.corretor.whatsapp && (
                                                            <a href={`https://wa.me/${selectedProperty.corretor.whatsapp}`} target="_blank" className="text-green-600 text-sm hover:underline">
                                                                Falar no WhatsApp
                                                            </a>
                                                        )}
